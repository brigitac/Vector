...
//        V2=V;
   ...
   // << ", capacity yra " << V2.capacity() << "\n";
    ...
    // std::cout<<*(v.begin()+9)<<std::endl;
    // v.erase(v.begin()+1,v.begin()+3);
    // V.erase(V.begin()+1,V.begin()+3);
    // std::cout<<v[0]<<" "<<v[1]<<" "<<v[2]<<" "<<v[3]<<" "<<v[4]<<" "<<v[5]<<" "<<v[93]<<" "<<v[94]<<" "<<v[95]<<" "<<v[96]<<" "<<v[97]<<" "<<v[98]<<" "<<v[99]<<std::endl;
    // std::cout<<V[0]<<" "<<V[1]<<" "<<V[2]<<" "<<V[3]<<" "<<v[4]<<" "<<v[5]<<" "<<v[93]<<" "<<v[94]<<" "<<v[95]<<" "<<v[96]<<" "<<v[97]<<" "<<V[98]<<" "<<V[99];
